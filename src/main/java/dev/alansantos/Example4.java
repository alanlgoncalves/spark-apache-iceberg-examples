...
public class Example4 {
    ...
    private static void deleteIcebergPartitionData(SparkSession sparkSession) {
        sparkSession.sql("select * from local.hub.flights where FLIGHT_DATE = '2015-01-01'").show(false);

        sparkSession.sql("DELETE FROM local.hub.flights WHERE FLIGHT_DATE = '2015-01-01'");
